const Linkedin = ({ size = 32, color = "white", fill = "black", ...props }) => (
  <svg
    width={size}
    height={size}
    viewBox="0 0 32 32"
  ...
  >
    <g clip-path="url(#clip0_2010_65)">
      <path d="M27 4H5C4.44772 4 4 4.44772 4 5V27C4 27.5523 4.44772 28 5 28H27C27.5523 28 28 27.5523 28 27V5C28 4.44772 27.5523 4 27 4Z" stroke={currentColor} stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
