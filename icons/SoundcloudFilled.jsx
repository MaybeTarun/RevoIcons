const SoundcloudFilled = ({ size = 32, color = "none", fill = "black", ...props }) => (
  <svg
    width={size}
    height={size}
    viewBox="0 0 32 32"
